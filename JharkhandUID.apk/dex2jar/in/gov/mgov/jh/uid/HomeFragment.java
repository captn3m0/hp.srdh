  ...
  extends Fragment
{
  EditText mobilenoEt;
  Button ok;
  EditText parameterEt;
  TextView text;
  ArrayAdapter<String> typeAdapter;
  Spinner typeSpinner;
  String[] typelist = { "SMS", "Internet" };
  
  @Nullable
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
  {
    paramLayoutInflater = paramLayoutInflater.inflate(2130968616, null);
    ok = ((Button)paramLayoutInflater.findViewById(2131492985));
    text = ((TextView)paramLayoutInflater.findViewById(2131492983));
    typeSpinner = ((Spinner)paramLayoutInflater.findViewById(2131492981));
    parameterEt = ((EditText)paramLayoutInflater.findViewById(2131492982));
    mobilenoEt = ((EditText)paramLayoutInflater.findViewById(2131492984));
    typeAdapter = new ArrayAdapter(getActivity(), 17367043, typelist);
    ...
    typeSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener()
    {
      public void onItemSelected(AdapterView<?> paramAnonymousAdapterView, View paramAnonymousView, int paramAnonymousInt, long paramAnonymousLong)
      {
        ...
        default: 
          return;
        case 0: 
          mobilenoEt.setVisibility(4);
          text.setVisibility(4);
          mobilenoEt.setText("");
          return;
        }
        mobilenoEt.setVisibility(0);
    ...
    ok.setOnClickListener(new View.OnClickListener()
    {
      ...
      {
        paramAnonymousView = parameterEt.getText().toString();
        String str = mobilenoEt.getText().toString();
        Object localObject = (String)typeSpinner.getSelectedItem();
        if (((String)localObject).equalsIgnoreCase("SMS"))
        {
          sendSMSRegular(paramAnonymousView);
          parameterEt.setText("");
        }
        int i;
        if (((String)localObject).equalsIgnoreCase("Internet"))
        {
          ...
          i = Connectioncheck.typeofConnectedNetwork(getActivity(), (ConnectivityManager)localObject);
          if ((str.equals("") | paramAnonymousView.equals(""))) {
            mobilenoEt.setError("Please Enter valid parameter and mobile number");
          }
        }
        else
        {
        ...
        if (i == 0)
        {
          paramAnonymousView = new Intent(getActivity(), NoNetwork.class);
          startActivity(paramAnonymousView);
          return;
        }
        new HomeFragment.SendSMSInternet(HomeFragment.this).execute(new String[] { str, paramAnonymousView });
        mobilenoEt.setText("");
        parameterEt.setText("");
      }
    });
  ...
  public void sendSMSRegular(String paramString)
  {
    if (paramString.equals(""))
    {
      parameterEt.setError("Please Enter valid parameter");
      return;
    }
    try
    {
      SmsManager.getDefault().sendTextMessage("166", null, "JH UID" + paramString, null, null);
      return;
    }
    catch (Exception paramString)
    {
      Toast.makeText(getActivity(), "SMS faild, please try again.", 1).show();
      paramString.printStackTrace();
    }
  }
  
  class SendSMSInternet
...
/* Location:
 * Qualified Name:     in.gov.mgov.jh.uid.HomeFragment
