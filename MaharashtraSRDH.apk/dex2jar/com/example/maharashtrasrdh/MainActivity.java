  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      {
        new AlertDialog.Builder(this).setTitle("MAHARASHTRA PULL SERVICES").setMessage("Do you want to Exit?").setNeutralButton("No", new DialogInterface.OnClickListener()
        {
    ...
    paramView.setIcon(2130837513);
    paramView.setTitle("MAHARASHTRA PULL SERVICES");
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    info = ((EditText)findViewById(2131230735));
